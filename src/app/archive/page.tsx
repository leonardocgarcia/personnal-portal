...
export const metadata: Metadata = {
  title: "Archive",
  description: "Every post, in chronological order.",
};
...
export default async function ArchivePage() {
  ...
  return (
    <div className={READ}>
      <h1 className="mb-2 text-2xl font-bold text-foreground">Archive</h1>
      <p className="mb-10 text-sm text-muted">
        Every post, newest to oldest — {posts.length} {posts.length === 1 ? "post" : "posts"}.
      </p>
